 ...
 * 椭圆按键
 */
public class AnjianWeitiaoVerticalView extends LinearLayout implements View.OnTouchListener {
    ...
    public AnjianWeitiaoVerticalView(Context context) {
        super(context, null);
    }

    public AnjianWeitiaoVerticalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        View contentView = inflate(getContext(), R.layout.view_anjian_weitiao_vertical, this);
