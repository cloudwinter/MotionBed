...
public class AnjianRectangleView extends LinearLayout {
    ...
    public AnjianRectangleView(Context context) {
        super(context,null);
    }

    public AnjianRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        View contentView = inflate(mContext,R.layout.view_anjian_rectangele,this);
