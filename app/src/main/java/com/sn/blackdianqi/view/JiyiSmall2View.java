 ...
 * 记忆view
 */
public class JiyiSmall2View extends RelativeLayout {
    ...
    public JiyiSmall2View(Context context) {
        super(context, null);
    }

    public JiyiSmall2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            isShowIcon = typedArray.getBoolean(R.styleable.JiyiView_showIcon, true);
