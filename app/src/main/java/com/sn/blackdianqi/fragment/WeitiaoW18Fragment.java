...
import com.sn.blackdianqi.databinding.FragmentWeitiaoW18Binding;


/**
 * 微调
 */
public class WeitiaoW18Fragment extends WeitiaoBaseFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentWeitiaoW18Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_weitiao_w18, container, false);
