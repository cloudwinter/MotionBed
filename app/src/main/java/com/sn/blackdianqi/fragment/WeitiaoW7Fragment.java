...
import com.sn.blackdianqi.databinding.FragmentWeitiaoW7Binding;
...
public class WeitiaoW7Fragment extends WeitiaoBaseFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentWeitiaoW7Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_weitiao_w7, container, false);
        ...
        fentiTuibutiaozhengLeftView = binding.viewFentiTuibutiaozhengLeft;
        fentiTuibutiaozhengRightView = binding.viewFentiTuibutiaozhengRight;
