...
import com.sn.blackdianqi.databinding.FragmentKuaijieK2Binding;
...
public class KuaijieK2Fragment extends KuaijieBaseFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentKuaijieK2Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_kuaijie_k2, container, false);
