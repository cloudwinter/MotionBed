...
import com.sn.blackdianqi.databinding.FragmentKuaijieK3Binding;
...
public class KuaijieK3Fragment extends KuaijieBaseFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentKuaijieK3Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_kuaijie_k3, container, false);
