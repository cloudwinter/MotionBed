...
public class KuaijieK11Fragment extends KuaijieBaseFragment implements View.OnTouchListener {
    ...
    private void initView() {
        ...
        zhengtishangshengView.setOnTouchListener(this);
        qianqingView.setOnTouchListener(this);
        fuyuanView.setOnTouchListener(this);

        zhengtixiajiangView.setOnTouchListener(this);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (v.getId()) {
            ...
            case R.id.view_zhihan:
                ...
                break;
            case R.id.view_zhengtishangsheng:
                setTopIconAndTitle(R.mipmap.xr_yijianshengqi_da,R.string.zhengtishangsheng);
                if (MotionEvent.ACTION_DOWN == action) {
                    sendBlueCmd("FF FF FF FF 05 00 00 00 21 17 18");
                }
                break;
            case R.id.view_qianqing:
                setTopIconAndTitle(R.mipmap.xr_tingyinyue_da,R.string.qianqing);
                if (MotionEvent.ACTION_DOWN == action) {
            ...
            case R.id.view_fuyuan:
                ...
                break;
            case R.id.view_zhengtixiajiang:
                setTopIconAndTitle(R.mipmap.xr_yijianjiangxia_da,R.string.zhengtixiajiang);
                if (MotionEvent.ACTION_DOWN == action) {
                    sendBlueCmd("FF FF FF FF 05 00 00 00 22 57 19");
                }
                break;
            case R.id.view_houqing:
                setTopIconAndTitle(R.mipmap.xr_tuibufangsong_da,R.string.houqing);
                if (MotionEvent.ACTION_DOWN == action) {
                    sendBlueCmd("FF FF FF FF 05 00 00 00 29 16 DE");
                }
                break;
            case R.id.view_zhengtifuyuan:
                setTopIconAndTitle(R.mipmap.xr_fuyuan_da,R.string.zhengtifuyuan);
                if (MotionEvent.ACTION_DOWN == action) {
                    sendBlueCmd("FF FF FF FF 05 00 00 00 2A 56 DF");
                }
                break;
