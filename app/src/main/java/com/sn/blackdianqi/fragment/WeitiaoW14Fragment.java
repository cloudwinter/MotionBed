...
import com.sn.blackdianqi.databinding.FragmentWeitiaoW14Binding;

/**
 * 微调
 */
public class WeitiaoW14Fragment extends WeitiaoBaseFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentWeitiaoW14Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_weitiao_w14, container, false);
    ...
    private void initView() {
        ...
        zhengtiqingxieView.setChildTouchListener(new ChildTouchListener() {
            @Override
            public void onTopTouch(MotionEvent event) {
                if (MotionEvent.ACTION_DOWN == event.getAction()) {
                    setTitle(R.string.zhengtiqingxie);
                    sendBlueCmd("FF FF FF FF 05 00 00 00 28 D7 1E");
                    //startAnimation(R.drawable.weitiao_zhengtishengjiang_top_animation);
                } else if (isUPorCancel(event.getAction())) {
                    setTopIconAndTitle(R.mipmap.xr_tingyinyue_da, R.string.zhengtiqingxie);
                    sendBlueCmd("FF FF FF FF 05 00 00 00 00 D7 00");
                    stopAnimation();
                }
            }
