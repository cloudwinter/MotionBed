 ...
 * MCU Base Fragment
 */
public abstract class BaseMcuFragment extends BaseFragment {

    public static final String TAG = "BaseMcuFragment";
    ...
    public void onAskStatusEvent(AskStatusgeEvent event) {
        Log.e("====BaseMcuFragment", "onAskStatusEvent Fragment界面初始化指令开始 ");
    ...
    protected void sendAskBlueCmd(final String cmd) {
        Log.e("====BaseMcuFragment", "sendAskBlueCmd 3333:" + cmd);
     ...
     * @param cmd
     */
    protected void sendAskBlueCRCCmd(final String cmd) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                sendBlueCRCCmd(cmd);
     ...
     * @param cmd
     */
    protected void sendBlueCRCCmd(String cmd) {
        cmd = cmd.replace(" ", "");
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) { //发现GATT服务器
                ...
                if (bundle != null) {
                    ...
                    if (data != null) {
//                        LogUtils.e("====BaseMcuFragment", "==MCU  接收设备返回的数据==", data);
